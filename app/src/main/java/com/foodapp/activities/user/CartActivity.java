...
import com.foodapp.activities.user.CartCheckoutActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCheckout.setOnClickListener(view -> {
            if (!cartItems.isEmpty()) {
                ...
                Intent intent = new Intent(CartActivity.this, com.foodapp.activities.user.CartCheckoutActivity.class);
